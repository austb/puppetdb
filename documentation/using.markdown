...
The PuppetDB plugins [installed on your Puppet master(s)](./connect_puppet_master.markdown) include a `status` action for the `node` face. On your Puppet master, run:
